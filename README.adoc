...
* All classes that need to be (de)serialized have to be annotated as `@Bindable`, or (if it's not your source) be listed in the `value` of some `@Bindable` annotation.
