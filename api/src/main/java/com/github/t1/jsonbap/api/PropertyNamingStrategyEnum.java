...
/**
 * Allows to define the strategy to derive the JSON field name from a Java property and vice versa.
 * This never overrides {@link jakarta.json.bind.annotation.JsonbProperty#value() JsonbProperty} annotations.
 */
